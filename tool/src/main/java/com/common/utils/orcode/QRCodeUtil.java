...
public class QRCodeUtil {
     ...
     * 默认宽度
     */
    private static final Integer WIDTH = 260;
    /**
     * 默认高度
     */
     ...
     * @return
     */
    public static InputStream getBase64QRCode(String content) {
     ...
     * @return
     */
    public static InputStream getBase64QRCode(String content, String logoUrl) {
     ...
     * @return
     */
    public InputStream getBase64QRCode(String content, Integer width, Integer height, String logoUrl, Integer logoWidth, Integer logoHeight) {
        return getBase64Image(content, width, height, logoUrl, logoWidth, logoHeight);
    }

    private static InputStream getBase64Image(String content, Integer width, Integer height, String logoUrl, Integer logoWidth, Integer logoHeight) {
